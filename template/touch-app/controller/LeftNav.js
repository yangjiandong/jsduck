    ...
    showGuide: function(name) {
        ...
        Ext.data.JsonP.request({
            ...
            success: function(json) {
                ...
                // this.getContent().setHtml('<div ontouchstart="window.event.preventDefault = function(){}" ontouchmove="window.event.preventDefault = function(){}" style="position: absolute; width: 100%; height: 100%; overflow: scroll; -webkit-overflow-scrolling: touch;"><div class="guide-container">' + json.guide + '</div></div>')
